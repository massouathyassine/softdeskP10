...
class Project(models.Model):
    ...
    TYPE_CONS = [("backend", "backend"), ("frontend", "frontend"), ("Android", "Android"), ("iOS", "iOS")]
    type = models.CharField(max_length=8, choices=TYPE_CONS, default="backend")
    author_user_id = models.ForeignKey(to=User, related_name="author_user_id_project",
...
class Contributor(models.Model):
    PERMISSION_CONST = [("Read", "Read"), ("All", "All")]
    ROLE_CONST = [("Author", "Author"), ("Manager", "Manager"), ("Creator", "Creator")]
    ...
    project_id = models.ForeignKey(to=Project, related_name="project_id_contributor", on_delete=models.CASCADE,
                                   blank=True, null=True)
    permission = models.CharField(max_length=4, choices=PERMISSION_CONST, default="All")
    role = models.CharField(max_length=7, choices=ROLE_CONST, default="Author")
